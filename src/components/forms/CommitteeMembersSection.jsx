...
/**
 * CommitteeMembersSection - Manages committee members, roles, and permissions
 * @param {Object} props
 * @param {number} props.committeeId - Committee ID (for edit mode)
 ...
 */
const CommitteeMembersSection = ({ committeeId, onChange, isEditMode = false, disabled = false }) => {
